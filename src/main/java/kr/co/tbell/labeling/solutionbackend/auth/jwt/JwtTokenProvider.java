package kr.co.tbell.labeling.solutionbackend.auth.jwt;
...
public class JwtTokenProvider {
    ...
    public AuthResponseDto.TokenInfo generateToken(Authentication authentication, Users users) {
        // 권한 가져오기
